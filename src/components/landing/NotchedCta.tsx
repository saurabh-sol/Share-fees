...
export function NotchedCta({
  ...
  return (
    <Link
      href={href}
      className="group relative inline-flex items-center justify-center bg-[#c23a3a] px-4 py-2.5 font-mono text-[11px] uppercase tracking-[0.18em] text-zinc-50 transition-colors hover:bg-[#9f2f2f] active:scale-[0.98] sm:px-7 sm:py-3"
    >
