...
const FAQS = [
  ...
  },
  {
    ...
    a: "USDG queues a payout to this wallet. LLM mints a t2c_ key for the provider you picked. Use the official OpenAI, Anthropic, or DeepSeek API against this origin. Usage spends remaining cents.",
  },
  {
