...
export const DOCS_PAGES: DocsPage[] = [
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "x402-agents", title: "Agents (x402 / USDG)" },
  ...
  },
  {
    ...
    section: "Take credit",
    keywords: ["x402", "agent", "meshgateway", "usdg", "402", "permit2", "facilitator", "mpp"],
    headings: [
      { id: "dual-rail", title: "Dual rail" },
      { id: "payment-flow", title: "Payment flow" },
      { id: "pricing", title: "Pricing" },
      { id: "routes", title: "Paywalled routes" },
      { id: "discovery", title: "Discovery" },
      { id: "receipt", title: "Settlement receipt" },
      { id: "agent-example", title: "Agent example" },
    ],
  },
  {
    href: "/docs/limits",
